    ...
    projects: Project[] = [
        {
          ...
          projectImages: ["../../assets/Image1.png","../../assets/Image2.png","../../assets/Image3.png"], 
      ...
      GetProjectById(id: number) : Project {
        ...
        if(project === undefined) {
          throw new Error("There is no project that matched the id: " + id);
        }
